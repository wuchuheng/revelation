...
import 'package:snotes/pages/home_page/devices/lg1024/directory_section/item_section/title_section.dart';
...
class NodeSectionState extends StatelessWidget {
  ...
  final void Function() handleDoubleTapNode;
  final bool isActive;
  final bool isBorder;
  ...
  const NodeSectionState({
    ...
    required this.handleDoubleTapNode,
